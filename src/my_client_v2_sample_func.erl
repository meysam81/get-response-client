...
-module(my_client_v2_sample_func).
...
encode_msg(Msg, Opts) ->
    ...
    case Msg of
      #'my_client_v2.sample.func.Func'{} ->
	  'e_msg_my_client_v2.sample.func.Func'(Msg);
...
'e_msg_my_client_v2.sample.func.Func'(#'my_client_v2.sample.func.Func'{x
									   =
									   F1},
				      Bin) ->
...
decode_msg(Bin, MsgName) when is_binary(Bin) ->
    case MsgName of
      'my_client_v2.sample.func.Func' ->
	  'd_msg_my_client_v2.sample.func.Func'(Bin);
      'my_client_v2.sample.type.FactResp' ->
...
'd_msg_my_client_v2.sample.func.Func'(Bin) ->
    'dfp_read_field_def_my_client_v2.sample.func.Func'(Bin,
						       0, 0, id(undefined)).

'dfp_read_field_def_my_client_v2.sample.func.Func'(<<8,
						     Rest/binary>>,
						   Z1, Z2, F1) ->
    'd_field_my_client_v2.sample.func.Func_x'(Rest, Z1, Z2,
					      F1);
'dfp_read_field_def_my_client_v2.sample.func.Func'(<<>>,
						   0, 0, F1) ->
    #'my_client_v2.sample.func.Func'{x = F1};
'dfp_read_field_def_my_client_v2.sample.func.Func'(Other,
						   Z1, Z2, F1) ->
    'dg_read_field_def_my_client_v2.sample.func.Func'(Other,
						      Z1, Z2, F1).

'dg_read_field_def_my_client_v2.sample.func.Func'(<<1:1,
						    X:7, Rest/binary>>,
						  N, Acc, F1)
    when N < 32 - 7 ->
    'dg_read_field_def_my_client_v2.sample.func.Func'(Rest,
						      N + 7, X bsl N + Acc, F1);
'dg_read_field_def_my_client_v2.sample.func.Func'(<<0:1,
						    X:7, Rest/binary>>,
						  N, Acc, F1) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  'd_field_my_client_v2.sample.func.Func_x'(Rest, 0, 0,
						    F1);
      _ ->
	  case Key band 7 of
	    0 ->
		'skip_varint_my_client_v2.sample.func.Func'(Rest, 0, 0,
							    F1);
	    1 ->
		'skip_64_my_client_v2.sample.func.Func'(Rest, 0, 0, F1);
	    2 ->
		'skip_length_delimited_my_client_v2.sample.func.Func'(Rest,
								      0, 0, F1);
	    5 ->
		'skip_32_my_client_v2.sample.func.Func'(Rest, 0, 0, F1)
	  end
    end;
'dg_read_field_def_my_client_v2.sample.func.Func'(<<>>,
						  0, 0, F1) ->
    #'my_client_v2.sample.func.Func'{x = F1}.

'd_field_my_client_v2.sample.func.Func_x'(<<1:1, X:7,
					    Rest/binary>>,
					  N, Acc, F1)
    when N < 57 ->
    'd_field_my_client_v2.sample.func.Func_x'(Rest, N + 7,
					      X bsl N + Acc, F1);
'd_field_my_client_v2.sample.func.Func_x'(<<0:1, X:7,
					    Rest/binary>>,
					  N, Acc, _) ->
    <<NewFValue:32/signed-native>> = <<(X bsl N +
					  Acc):32/unsigned-native>>,
    'dfp_read_field_def_my_client_v2.sample.func.Func'(Rest,
						       0, 0, NewFValue).


'skip_varint_my_client_v2.sample.func.Func'(<<1:1, _:7,
					      Rest/binary>>,
					    Z1, Z2, F1) ->
    'skip_varint_my_client_v2.sample.func.Func'(Rest, Z1,
						Z2, F1);
'skip_varint_my_client_v2.sample.func.Func'(<<0:1, _:7,
					      Rest/binary>>,
					    Z1, Z2, F1) ->
    'dfp_read_field_def_my_client_v2.sample.func.Func'(Rest,
						       Z1, Z2, F1).
...
'skip_length_delimited_my_client_v2.sample.func.Func'(<<1:1,
							X:7, Rest/binary>>,
						      N, Acc, F1)
    when N < 57 ->
    'skip_length_delimited_my_client_v2.sample.func.Func'(Rest,
							  N + 7, X bsl N + Acc,
							  F1);
'skip_length_delimited_my_client_v2.sample.func.Func'(<<0:1,
							X:7, Rest/binary>>,
						      N, Acc, F1) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    'dfp_read_field_def_my_client_v2.sample.func.Func'(Rest2,
						       0, 0, F1).


'skip_32_my_client_v2.sample.func.Func'(<<_:32,
					  Rest/binary>>,
					Z1, Z2, F1) ->
    'dfp_read_field_def_my_client_v2.sample.func.Func'(Rest,
						       Z1, Z2, F1).
...
'skip_64_my_client_v2.sample.func.Func'(<<_:64,
					  Rest/binary>>,
					Z1, Z2, F1) ->
    'dfp_read_field_def_my_client_v2.sample.func.Func'(Rest,
						       Z1, Z2, F1).
...
merge_msgs(Prev, New)
    ...
    case Prev of
      #'my_client_v2.sample.func.Func'{} ->
	  'merge_msg_my_client_v2.sample.func.Func'(Prev, New);
      #'my_client_v2.sample.type.FactResp'{} ->
	  'merge_msg_my_client_v2.sample.type.FactResp'(Prev, New)
    end.

'merge_msg_my_client_v2.sample.func.Func'(#'my_client_v2.sample.func.Func'{x
									       =
									       PFx},
					  #'my_client_v2.sample.func.Func'{x =
									       NFx}) ->
    #'my_client_v2.sample.func.Func'{x =
...
verify_msg(Msg) ->
    case Msg of
      #'my_client_v2.sample.func.Func'{} ->
	  'v_msg_my_client_v2.sample.func.Func'(Msg,
						['my_client_v2.sample.func.Func']);
      #'my_client_v2.sample.type.FactResp'{} ->
...
'v_msg_my_client_v2.sample.func.Func'(#'my_client_v2.sample.func.Func'{x
									   =
									   F1},
				      Path) ->
...
get_msg_defs() ->
    [{{msg, 'my_client_v2.sample.func.Func'},
...
find_msg_def('my_client_v2.sample.func.Func') ->
    [#field{name = x, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []}];
...
get_package_name() -> 'my_client_v2.sample.func'.
